...
import { renderHome, bindHomeEvents } from './pages/home.js?v=17';
import { renderArticle, bindArticleEvents } from './pages/article.js?v=17';
import { renderPhotos, bindPhotosEvents } from './pages/photos.js?v=17';
import { renderAbout, bindAboutEvents } from './pages/about.js?v=17';
import { renderAdmin, bindAdminEvents } from './pages/admin.js?v=17';
import { renderNav } from './components/nav.js?v=17';
